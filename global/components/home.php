...
<div class="home bg-transparent">
    ...
    <div class="text-center mt-5 wow fadeInUp">
        <a href="/Project/admin" class="btn btn-info rounded-pill col-md-3 col-6 mr-md-3">Admins Universe</a>
        <a href="/Project/userpanel" class="btn btn-primary rounded-pill col-md-3 col-6 mt-md-0 mt-3">Users Universe</a>
    </div>
